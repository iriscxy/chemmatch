...
def consistency_loss(logits, targets, name='ce',weights=None, mask=None):
    """
    ...
    if name == 'mse':
        ...
        loss = ce_loss(logits, targets,weights=weights, reduction='none')
...
class ConsistencyLoss(nn.Module):
    ...
    """
    def forward(self, logits, targets, name='ce',weights=None, mask=None):
        return consistency_loss(logits, targets, name, weights,mask)